...
SELECT c.customer_id, c.first_name, c.last_name, tsa.artist_name, SUM(il.unit_price*il.quantity) AS amount_spent
FROM customer AS c
...
(
    SELECT customer.country, genre.name, genre.genre_id,COUNT(invoice_line.quantity) AS total_purchase, 
